...
def momentplot():
    ...
    plt.show()
    print 'the error graph shows the error in %'

#MOMENT AROUND
#3_right_loc is 288. for normal flight, 145. when close to the pilots

def momentcalc( fuel, right3loc, pilot1, pilot2, coordinator, left1, right1, left2, right2, left3, right3 ):
    passengers = pilot1+pilot2+coordinator+left1+right1+left2+right2+left3+right3
